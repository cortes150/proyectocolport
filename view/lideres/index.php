			...
			<div class="jumbotron">
				<div class="row">
					<div class="col-md-8">
						...
						<p>
							<a class="btn btn-primary btn-large" href="?c=Grupo&a=Index&idz=<?php echo $stm->zonaID;?>"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> - Ver Grupos</a>
						</p>
					</div>
					<div class="col-md-4">
			...
			<table class="table">
				...
				<?php foreach($this->model->listarColportoresLibros() as $r): ?>
					<tr>
						...
						<td>
							<a class="btn btn-primary" href="?c=Zona&a=MIembroLibroAsignado&id=<?php echo $r->miemID; ?>"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> - Ver Detalles</a>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
